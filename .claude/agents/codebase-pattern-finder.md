...
## Pattern Categories
• **CLI**: Commands, options, callbacks, validators
• **Data**: Models, serialization, transformations
• **Services**: Business logic, async operations, integrations
• **Testing**: Unit/integration setup, fixtures, assertions
