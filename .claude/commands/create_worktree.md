...
git checkout main  # or feature/m1-issue-01-project-setup
git pull origin main

# Verify tests pass on base branch (adjust command to your project)
poetry run pytest || echo "Tests failing on base branch - fix before creating worktree"
```
...
git worktree add -b feat/user-auth ../cow-performance-testing-suite-user-auth main

# Create fix branch worktree
git worktree add -b fix/login-bug ../cow-performance-testing-suite-login-fix main
```
...
cp ../cow-performance-testing-suite/.env .env
